...
template<class T1,class T2> istream & operator>>(istream& in ,  pair<T1,T2> &input){in>>input.first>>input.second; return in;}
template<class T1,class T2> ostream & operator<<(ostream& out , const pair<T1,T2> &output){out<<output.first<<" "<<output.second<<endl; return out;}
template<class T1,class T2> void deb(T1 e1, T2 e2){cerr << e1 << space << e2 << endl;} 
template<class T1,class T2,class T3> void deb(T1 e1, T2 e2, T3 e3) {cerr << e1 << space << e2 << space << e3 << endl;} 
template<class T1,class T2,class T3,class T4> void deb(T1 e1, T2 e2, T3 e3, T4 e4){cerr << e1 << space << e2 << space << e3 << space << e4 << endl;} 
template<class T1,class T2,class T3,class T4,class T5> void deb(T1 e1, T2 e2, T3 e3, T4 e4, T5 e5){cerr << e1 << space << e2 << space << e3 << space << e4 << space << e5 << endl;} 
template<class T1,class T2,class T3,class T4,class T5,class T6> void deb(T1 e1, T2 e2, T3 e3, T4 e4 ,T5 e5, T6 e6){cerr << e1 << space << e2 << space << e3 << space << e4 << space << e5 << space << e6 << endl;} 
